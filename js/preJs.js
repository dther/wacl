(function (self) {
  ...
  Module['print'] = function(txt) { console.log('surftcl stdout: ' + txt); };
  Module['printErr'] = function(txt) { console.error('surftcl stderr: ' + txt); };
  Module['filePackagePrefixURL'] = 'surftcl/';
  ...
  Module['postRun'] = function () {
    ...
    _Result = {
      ...
      jswrap: function(fcn, returnType, argType) {
        ...
        return "::surftcl::jscall " + fnPtr + " " + returnType + " " + argType;
      },
